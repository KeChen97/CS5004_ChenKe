...
public class ShapeTest {
  ...
  public void testObjectData() {
    ...
    assertEquals("Rectangle: LL corner (2.000,3.000) width 10.000 height 10" +
            ".000",rect2
            .toString());
    assertEquals("Triangle: first point (0.000,0.000) second point (1.000,0.000) third point (1.000,1.000)",tri1.toString());
    assertEquals("Triangle: first point (0.000,0.000) second point (1.000,-1.000) third point (1.000,1.000)",tri2.toString());
