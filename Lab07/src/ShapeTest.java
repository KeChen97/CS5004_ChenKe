...
public class ShapeTest {
  ...
  Shape circle1, circle2, circle3, rect1, rect2, tri1, tri2, tri3, tri4;
  ...
  public void setup() {
    ...
    tri1 = new Triangle(0, 0, 1, 0, 1, 1);
    tri2 = new Triangle(0, 0, 1, -1, 1, 1);
    tri3 = new Triangle(0, 0, 2, 0, 1, 1);
    tri4 = new Triangle(0, 0, 0, -1, 1, 1);
  }

  /**
   * Test whether it will throw illegalArgument if points are same
   */
  @Test(expected = IllegalArgumentException.class)
  public void testTriangle() {
    tri1 = new Triangle(0, 0, 0, 0, 0, 1);
  }
  ...
  public void testObjectData() {
    ...
    assertEquals("Rectangle: LL corner (2.000,3.000) width 10.000 height 10" +
        ...
        .toString());
    assertEquals(
        "Triangle: first point (0.000,0.000) second point (1.000,0.000) third point (1.000,1.000)",
        tri1.toString());
    assertEquals(
        "Triangle: first point (0.000,0.000) second point (1.000,-1.000) third point (1.000,1.000)",
        tri2.toString());
  ...
  public void testArea() {
    ...
    assertEquals(0.5, tri1.area(), 0.01);
    assertEquals(1, tri2.area(), 0.01);
    assertEquals(1, tri3.area(), 0.01);
    assertEquals(0.5, tri4.area(), 0.01);
  }
  ...
  public void testPerimeter() {
    ...
    assertEquals(2 + Math.sqrt(2), tri1.perimeter(), 0.001);
    assertEquals(2 + 2 * Math.sqrt(2), tri2.perimeter(), 0.001);
  }
  ...
  public void testResizes() {
    ...
    resizedTri1 = tri1.resize(2);
    resizedTri2 = tri2.resize(10);
    ...
    assertEquals(2 * tri1.area(), resizedTri1.area(), 0.001);
    assertEquals(10 * tri2.area(), resizedTri2.area(), 0.001);
  }

  /**
   * Tests whether the compareTo methods work correctly for all shapes compareTo based on perimeter
   */
  @Test
  public void testCompareTo() {
    ...
    assertEquals(1, rect2.compareTo(rect1));
    assertEquals(-1, tri1.compareTo(tri2));
    assertEquals(1, tri2.compareTo(tri1));
  }

  /**
   * Tests whether the compareTo methods work correctly for all shapes compare two shape based on
   * the distance from origin
   */
  @Test
  public void testCompare() {
    assertEquals(-1, DistComparator.compare(tri1, circle1));
    assertEquals(0, DistComparator.compare(tri1, tri2));
    assertEquals(1, DistComparator.compare(circle2, rect2));
  }
