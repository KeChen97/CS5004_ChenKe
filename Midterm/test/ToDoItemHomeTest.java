...
public class ToDoItemHomeTest {
  ...
  public void compareTo() {
    ...
    assertEquals(-1, this.item2.compareTo(this.item3));
  }
  ...
  public void testToString() {
    assertEquals("Item:Laundry Status:UNSTARTED Category:HOME Importance:4 Comments:[Clothes]\n",item1.toString());
    assertEquals("Item:Laundry Status:UNSTARTED Category:HOME Importance:4 Comments:[Clothes]\n",item3.toString());
    assertEquals("Item:DishWashing Status:COMPLETED Category:HOME Importance:2 Comments:[Bowls]\n",item2.toString());
  }
}